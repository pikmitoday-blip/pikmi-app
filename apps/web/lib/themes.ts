...
export type BlockStyleId = "rounded" | "sharp" | "hard";
...
export const BLOCK_STYLES: BlockStyleDef[] = [
  { id: "rounded", name: "Zaobljeni",   previewRadius: 20, geom: { block: 20, inner: 14, pill: 999, avatar: 20 } },
  { id: "sharp",   name: "Oštri",       previewRadius: 3,  geom: { block: 3,  inner: 3,  pill: 4,   avatar: 4 } },
  { id: "hard",    name: "Tvrda senka", previewRadius: 8,  geom: { block: 12, inner: 10, pill: 8,   avatar: 12, hardShadow: true } },
];

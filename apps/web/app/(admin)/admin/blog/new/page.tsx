...
export default function NewBlogPost() {
  ...
  async function save() {
    ...
    const { error: err } = await supabase.from("blog_posts").insert({
      ...
      excerpt: form.excerpt, seo_title: form.seo_title || form.title,
      seo_description: form.seo_description || form.excerpt,
      cover_image: form.cover_image, published: publishNow,
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
            <div onClick={() => setPublishNow(v => !v)} style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            <input value={form.title} onChange={e => set("title", e.target.value)}
              ...
              style={{ width: "100%", background: "transparent", border: "none", outline: "none", fontSize: 22, fontWeight: 700, color: "#F9FAFB", fontFamily: "inherit", boxSizing: "border-box" }} />
          </div>
          ...
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              ...
              <input value={form.slug}
                ...
                style={{ flex: 1, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 6, padding: "6px 10px", color: "#A78BFA", fontSize: 13, fontFamily: "monospace", outline: "none" }} />
            </div>
          </div>

          {/* Cover slika — u content tabu */}
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            {form.cover_image && (
              <div style={{ borderRadius: 8, overflow: "hidden", maxHeight: 200 }}>
                ...
                <img src={form.cover_image} alt="Cover" style={{ width: "100%", maxHeight: 200, objectFit: "cover" }} />
              </div>
            )}
          </div>
          ...
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            <textarea value={form.excerpt} onChange={e => set("excerpt", e.target.value)}
              ...
              rows={2}
              style={{ width: "100%", background: "transparent", border: "none", outline: "none", resize: "none", fontSize: 14, color: "#D1D5DB", fontFamily: "inherit", lineHeight: 1.6, boxSizing: "border-box" }} />
          </div>
          ...
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            <textarea
              ...
              rows={20}
              style={{ width: "100%", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 8, padding: "14px", outline: "none", resize: "vertical", fontSize: 14, color: "#D1D5DB", fontFamily: "monospace", lineHeight: 1.7, boxSizing: "border-box" }} />
          </div>
        </div>
      )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            <input value={form.seo_title} onChange={e => set("seo_title", e.target.value)}
              ...
              style={{ width: "100%", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, padding: "10px 12px", color: "#F9FAFB", fontSize: 14, fontFamily: "inherit", outline: "none", boxSizing: "border-box" }} />
            <div style={{ fontSize: 11, color: "#374151", marginTop: 6 }}>Ostaviti prazno = koristiće se naslov posta</div>
          </div>
          ...
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 11, color: charCountDesc > 160 ? "#F87171" : charCountDesc > 120 ? "#FBBF24" : "#4B5563" }}>{charCountDesc}/160</span>
            </div>
            <textarea value={form.seo_description} onChange={e => set("seo_description", e.target.value)}
              ...
              rows={3}
              style={{ width: "100%", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, padding: "10px 12px", color: "#F9FAFB", fontSize: 14, fontFamily: "inherit", outline: "none", resize: "none", boxSizing: "border-box" }} />
          ...
          <div style={{ background: "#111116", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ background: "#1e1e1e", borderRadius: 8, padding: "16px 18px" }}>
              ...
              <div style={{ fontSize: 16, color: "#60A5FA", fontWeight: 500, marginBottom: 4 }}>{form.seo_title || form.title || "Naslov posta"}</div>
              <div style={{ fontSize: 13, color: "#9CA3AF", lineHeight: 1.5 }}>{form.seo_description || form.excerpt || "Meta opis će se prikazati ovde u Google rezultatima pretrage..."}</div>
            </div>
          </div>
        </div>
      )}
